...
class AIService
{
    ...
    public function generateText(string $prompt): string
    {
        try {
            ...
            // Return a helpful fallback response with demo content
            return "**Demo Mode - API Limit Reached**\n\n" .
                   "# " . ucfirst($prompt) . "\n\n" .
                   "This is a demonstration of how the AI blog generator would work. " .
                   "In a real scenario, this would be generated by OpenAI's GPT model.\n\n" .
                   "## Key Points:\n" .
                   "- Professional AI-powered content generation\n" .
                   "- Laravel-based architecture\n" .
                   "- Secure API integration\n\n" .
                   "**Note:** To use real AI generation, ensure your OpenAI API key has available credits.\n\n" .
